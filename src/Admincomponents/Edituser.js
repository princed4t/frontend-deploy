...
<div>
    ...
    <input type={"text"} id="proweight"name="proweight"onChange={myhandler}  value={userdto.proweight}className='form-control' required/>


</div>
<div>
    <label htmlFor='email'className='form-label'>prodistance</label>
    <input type={"text"} id="prodistance"name="prodistance"onChange={myhandler}  value={userdto.prodistance}className='form-control' required/>
